...
{
	addTitle("Vehicle");
	if (menu.MenuOption("~HUD_COLOUR_DEGEN_RED~Casino", "vehiclelist", { "1.46 Only" })) Vcat = Casino;
	if (menu.MenuOption("Arena", "vehiclelist", { "1.46 Only" })) Vcat = Arena;
