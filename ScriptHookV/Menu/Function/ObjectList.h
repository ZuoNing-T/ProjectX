...
//This is use for change player model or bodygard(maybe)
std::vector<std::string> player_model =
{
...
//This is use for change player model movement
static std::vector<std::string> movementname = {
	"Generic Male",
	"Generic Female",
	"Policeman",
	"Gangster",
